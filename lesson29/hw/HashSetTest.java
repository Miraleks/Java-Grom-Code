...
//        add(E e)
//        remove(E e)
//        retailAll(Collection<E> c) - на уроке не проходили, попробуйте разобраться что делает этот метод самостоятельно - удаляет все, кроме существующих в другой коллекции
//        Object[] toArray()
//        size()
